  ...
  return (
    ...
    >
      <div className="hidden md:inline-flex flex-1">
        <input
          type="text"
          className="lg:w-1/3 border border-r-0 border-theme2 rounded-none rounded-l-md font-light focus:ring-0 focus:border-theme1"
          placeholder="Search..."
        />
        <button className="px-3 rounded-none rounded-r-md bg-theme1 hover:bg-theme1 text-indigo-200 focus:outline-none">
      ...
      <a href="!#" className="relative text-theme1 hover:text-theme2">
      ...
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="inline-flex justify-center w-full items-center text-theme1 hover:text-gray-800 focus:outline-none">
